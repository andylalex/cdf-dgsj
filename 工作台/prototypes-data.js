    ...
    "hotspots": [
      {
        ...
        "h": 10,
        "title": "导购/来源信息栏",
        "desc": "PRD 5.2.3/3.3.1：展示专属导购、门店/平台来源及推荐关系，多门店导购加购时对应「选择导购」弹窗（最佳推荐排首位默认选中、单选项），明确订单归因对象。",
        "num": 1
      },
      {
        "id": "u4-f1",
      ...
      },
      {
        ...
        "h": 30,
        "title": "商品与优惠区",
        "desc": "展示商品卡片、数量、小计、可用优惠券及金额计算；同一商品经多个导购推荐加购需拆行。",
        "num": 3
      },
      {
        "id": "u4-r1",
    ...
    "hotspots": [
      {
        ...
        "h": 30,
        "title": "门店分组卡片",
        "desc": "展示门店（海口国际免税城）下导购代客加购的商品，含单价、导购信息与政府消费券标签（PRD 5.2.2 购物清单）。"
      },
      {
        "id": "u6-e2",
        "selector": "",
