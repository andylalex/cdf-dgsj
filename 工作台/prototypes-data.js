...
const PROTOTYPES_V03=[
  {
    ...
    "hotspots": [
      {
        "id": "u1-e1",
        "selector": ".phone-frame > div:first-child",
        "fixed": true,
        "type": "element",
        "x": 50,
        "y": 4,
        ...
        "h": 7,
        "title": "导购信息栏",
        "desc": "导购头像、昵称、店铺名；顾客可点击查看导购主页或拨打电话。",
        "num": 1
      },
      {
        "id": "u1-e2",
        "selector": ".flex-1.overflow-y-auto > div:nth-child(2)",
        "type": "element",
        "x": 50,
        "y": 24,
        "w": 86,
      ...
      {
        "id": "u1-e3",
        "selector": ".flex-1.overflow-y-auto > div:nth-child(4)",
        "type": "element",
        "x": 50,
        "y": 44,
        "w": 86,
        "h": 12,
        "title": "品牌推荐卡片",
        "desc": "品牌 logo+品牌名称/在售数量/品牌专区链接/品牌 banner；点击进入通用品牌店铺列表页，传入导购信息进入导购模式，非当前门店商品沉底。",
        "num": 3
      },
      {
        "id": "u1-e4",
        "selector": ".flex-1.overflow-y-auto > div:nth-child(6)",
        "type": "element",
        "x": 50,
        "y": 60,
        "w": 86,
      ...
      },
      {
        ...
        "rule": {
          "code": "R-U1-01",
          "trigger": "顾客点击商品/品牌推荐卡片",
          "behavior": "进入对应商品详情/品牌专区时携带导购信息、进入导购模式，开始业绩归因流程；退出导购模式后点击不再归因",
          "exception": "同一商品多导购推荐加购需拆行归因"
        },
        "num": 5
      }
    ]
  ...
  },
  {
    ...
    "hotspots": [
      ...
      },
      {
        ...
        "rule": {
          "code": "R-U4-01",
          "trigger": "提交订单 / 订单生成后未支付",
          "behavior": "导购模式下提交即把导购信息写入订单用于业绩归因（仅已完成未退款商品计入）；订单进入待支付，倒计时 30 分钟",
          "exception": "超时被取消并释放库存；用户主动取消或支付失败同样释放"
        },
        "num": 4
      },
      {
    ...
    "hotspots": [
      {
        ...
        "h": 10,
        "title": "行程类型选择",
        "desc": "飞机/火车/轮船/自驾切换，决定后续字段集（PRD 离岛信息：飞机含航班号/境内境外/购票证件号；火车含车次/乘车地点；渡轮含渡轮号/离岛港口）。",
        "num": 1
      },
      {
        "id": "u5-f1",
  ...
  },
  {
    ...
    "hotspots": [
      {
        "id": "g8-e1",
        "selector": ".phone-frame > div:nth-child(2)",
        "type": "element",
        "x": 50,
        "y": 15,
        "w": 86,
      ...
      {
        "id": "g8-e2",
        "selector": ".phone-frame > div:nth-child(3)",
        "type": "element",
        "x": 50,
        "y": 33,
        "w": 86,
    ...
    "fields": [
      {
        ...
        "type": "string",
        "required": "是",
        "format": "商品唯一编码；门店品以 C 开头，电商品以 E 开头",
      ...
      },
      {
        ...
        "type": "number",
        "required": "—",
        "format": "电商库存（平台库存，来源=电商时的可用量）；0 表示缺货",
        "sample": "88 / 0(缺货)"
      },
      {
        "name": "group",
  ...
  "ShoppingList": {
    ...
    "fields": [
      ...
      },
      {
        ...
        "type": "enum",
        "required": "是",
        "format": "结算来源；约束：门店与电商商品不可合并结算，必须同来源",
        "sample": "—"
      },
      {
        "name": "guide",
  ...
  "Order": {
    ...
    "fields": [
      ...
      },
      {
        ...
        "type": "Coupon",
        "required": "—",
        "format": "使用的优惠券（U4 优惠券卡，见 Coupon）",
        "sample": "—"
      },
      {
        "name": "fee",
  ...
  "Conversation": {
    ...
    "fields": [
      ...
      },
      {
        ...
        "type": "enum",
        "required": "—",
        "format": "Message.type：text/image/product/shoppingList/coupon",
        "sample": "—"
      },
      {
        "name": "content",
